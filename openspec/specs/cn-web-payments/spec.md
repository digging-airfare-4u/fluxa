# cn-web-payments Specification

## Purpose

Define Fluxa web payment capabilities for CN channels (Alipay/WeChat), including checkout channel selection, idempotent settlement, membership/points fulfillment consistency, and operational recovery/refund traceability.

...
Define invite-code-based membership rewards, including deferred redemption flow, anti-abuse constraints, manual fallback redemption, and normalized error semantics.

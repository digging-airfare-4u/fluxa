...
Define expected behavior for dragging local image files onto canvas, including upload, persistence, placeholder lifecycle, compression policy, and batch failure handling.
